...
from project_fun import dateDecoder
...
class cleaner(object):
    ...
    def __init__ (self, pathtofile):
        ...
        # self.df = pd.read_csv(pathtofile, delim_whitespace=True)

        self.df = pd.read_csv(pathtofile, delim_whitespace=True, nrows=1000000)

        # Set column names to dataframe 'Household ID, timestamp, consumption in kWh'
    ...
    def _dates(self):
        '''
        Returns timedelta decoded from following format:
        ...
        self.df.ts = self.df.ts.apply(dateDecoder)
    ...
    def fit(self):
        ...
        #1. Transform dates to workable format.
        self._dates()
